...
div(id = "why",
    hidden = "true", 
    HTML("Because my favorite time of the year to appreciate everything nature has to provide is autumn, and guess what late October, its PEAK foliage season, like come on LOOK at this"))
```
